...
<html lang="en">
  <head>
    ...
    <title>Catering Management System | <?php echo $title; ?></title>
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#">Catering Management System</a>
			</div>
			<div>
				<ul class="nav navbar-nav navbar-right signup">

					<li >
				  <a  class="dropdown-toggle> " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Registration <span class="caret"></span></a>
				  <ul class="dropdown-menu">
					<li><a href="Dailyreg.php">Daily</a></li>
					<li><a href="Monthlyreg.php">Monthly</a></li>
					<li><a href="Weeklyreg.php">Weekly</a></li>
				  ...
				  <ul class="dropdown-menu">
					<li><a href="Dlog.php">Daily</a></li>
					<li><a href="Mlog.php">Monthly</a></li>
					<li><a href="Wlog.php">Weekly</a></li>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav navbar-right top_menu">
				...
				<li class="dropdown <?php if($page=="arts") echo "active" ?>">
				  <a class="dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Packages <span class="caret"></span></a>
				  <ul class="dropdown-menu">
					<li><a href="Pdaily.php">Daily</a></li>
					<li><a href="Pmonthly.php">Monthly</a></li>
					<li><a href="Pweekly.php">Weekly</a></li>
